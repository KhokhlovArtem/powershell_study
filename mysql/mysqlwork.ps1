...
$connstring = "Server=192.168.7.128;Uid=testuser;Pwd=1q2w3e;database=mysql;CharSet=utf8"
$SQLQuery = "select user from user"
$res = run-MySQLQuery -ConnectionString $connString -Query $SQLQuery | Out-String

Run-SendEmail -to "3010@modis.ru" -subject "test" -body $res
